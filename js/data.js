    ...
    levels: [
      ...
      { no:'Level 2', name:'CVC 短元音', desc:'CVC 结构单词拼读练习', lessons: [
        ...
        { id:'pb2', sym:'-an', title:'-an 家族', sub:'短 a 词族', tip:'-an 发 /æn/。注意 n 的鼻音结尾。', words:[
          {w:'can',m:'能'},{w:'man',m:'男人'},{w:'fan',m:'风扇'},{w:'pan',m:'平底锅'},{w:'ran',m:'跑'},{w:'tan',m:'棕'},{w:'van',m:'货车'},{w:'ban',m:'禁止'},{w:'plan',m:'计划'},{w:'clan',m:'氏族'},{w:'scan',m:'扫描'},{w:'bran',m:'麸'},{w:'span',m:'跨度'},{w:'than',m:'比'},{w:'stan',m:'站'},{w:'jan',m:'一月'},{w:'cyan',m:'青'},{w:'an',m:'在'},{w:'dan',m:'丹'},{w:'flan',m:'果馅饼'} ] },
        ...
        { id:'pb4', sym:'-et', title:'-et 家族', sub:'短 e 词族', tip:'-et 发 /et/。e 短音要短促。', words:[
          {w:'bet',m:'打赌'},{w:'let',m:'让'},{w:'met',m:'遇见'},{w:'net',m:'网'},{w:'pet',m:'宠物'},{w:'set',m:'放'},{w:'wet',m:'湿'},{w:'jet',m:'喷气'},{w:'vet',m:'兽医'},{w:'yet',m:'还'},{w:'get',m:'得到'},{w:'fret',m:'烦躁'},{w:'kept',m:'保持'},{w:'wept',m:'哭泣'},{w:'debt',m:'债'},{w:'belt',m:'腰带'},{w:'felt',m:'感觉'},{w:'melt',m:'融化'},{w:'pelt',m:'投掷'},{w:'abet',m:'教唆'} ] },
        ...
        { id:'pb7', sym:'-og', title:'-og 家族', sub:'短 a 词族', tip:'-og 发 /ɒg/。o 短奥。', words:[
          {w:'dog',m:'狗'},{w:'log',m:'原木'},{w:'fog',m:'雾'},{w:'hog',m:'猪'},{w:'jog',m:'慢跑'},{w:'bog',m:'泥沼'},{w:'cog',m:'齿轮'},{w:'frog',m:'青蛙'},{w:'smog',m:'烟'},{w:'blog',m:'博客'},{w:'clog',m:'阻塞'},{w:'flog',m:'鞭打'},{w:'slog',m:'苦干'},{w:'tog',m:'外套'},{w:'nog',m:'木块'},{w:'agog',m:'急切的'},{w:'backlog',m:'积压'},{w:'bulldog',m:'斗牛犬'},{w:'hotdog',m:'热狗'},{w:'groundhog',m:'土拨鼠'} ] },
        { id:'pb8', sym:'-ug', title:'-ug 家族', sub:'短 u 词族', tip:'-ug 发 /ʌg/。u 短阿。', words:[
          {w:'bug',m:'小虫'},{w:'dug',m:'挖(过)'},{w:'hug',m:'拥抱'},{w:'jug',m:'水壶'},{w:'mug',m:'杯子'},{w:'rug',m:'地毯'},{w:'tug',m:'拖'},{w:'pug',m:'哈巴狗'},{w:'slug',m:'鼻涕虫'},{w:'plug',m:'插头'},{w:'snug',m:'温暖'},{w:'drug',m:'药'},{w:'chug',m:'咔嚓'},{w:'thug',m:'暴徒'},{w:'shrug',m:'耸肩'},{w:'smug',m:'自满'},{w:'debug',m:'调试'},{w:'unplug',m:'拔掉插头'},{w:'bedbug',m:'臭虫'},{w:'humbug',m:'骗子'} ] }
      ]},
      ...
      { no:'Level 4', name:'元音组合', desc:'高频元音字母组合拼读', lessons: [
        ...
        { id:'pd7', sym:'igh', title:'igh 组合', sub:'长 i 组合', tip:'igh 发 /aɪ/ 长 i，如 light、night。', words:[
          {w:'light',m:'光'},{w:'night',m:'夜'},{w:'right',m:'右'},{w:'high',m:'高'},{w:'bright',m:'亮'},{w:'flight',m:'航班'},{w:'sight',m:'视'},{w:'tight',m:'紧'},{w:'fight',m:'战'},{w:'might',m:'可能'},{w:'fright',m:'惊'},{w:'knight',m:'骑士'},{w:'slight',m:'轻'},{w:'blight',m:'枯萎'},{w:'plight',m:'困境'},{w:'alight',m:'点亮'},{w:'thigh',m:'大腿'},{w:'wright',m:'工匠'},{w:'midnight',m:'午夜'},{w:'delight',m:'高兴'} ] },
